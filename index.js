...
obGlobal.bdMongo = obGlobal.clientMongo.db('cti');
...
/*Pentru debuging la baza de date ca sa arate erori de logare
app.get("/mobila", function(req, res){
    ...
    */
    ...
    formular.parse(req, function(err, campuriText, campuriFisier ){
        ...
        Utilizator.getUtilizDupaUsername (campuriText.username[0],parametriCallback,
             function(u, obparam, eroare ){//procezeazaUtiliz
...
app.post("/profil", function(req, res){
    ...
    formular.parse(req,function(err, campuriText, campuriFile){
        ...
        function(err, rez){
            ...
            //mail update
            req.session.utilizator.trimiteMail("Salut, stimate"+campuriText.nume[0],"Datele tale au fost actualizate",
            `<h1>Detalii</h1><p Nume: ${campuriText.nume[0]}.</p> 
            <p Prenume: ${campuriText.prenume[0]}.</p>
            <p Email: ${campuriText.email[0]}.</p>
            <p Culoare_chat: ${campuriText.culoare_chat[0]}.</p>`);
...
app.post("/sterge_utiliz", function(req, res){
    ...
    * completam obiectComanda cu parametrii comenzii select pentru a prelua toti utilizatorii
    */
    if(req?.utilizator?.areDreptul(Drepturi.s)){
        var formular= new formidable.IncomingForm();
